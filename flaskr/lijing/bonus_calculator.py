        ...
        if filename.endswith(".xlsx"):
            ...
            for i in range(9):
                ...
                for row in range(1, table.nrows - 1):
                    ...
                    log_string.append("%.2f-%.2f=%.2f" % (average, average_total, diff))
                    ...
                    log_string.append(
                        "%.2f*%.2f=%.2f" % (value_dict["bonus3"], diff, addition)
                    )
            ...
            for i in range(1, table.nrows - 1):
                ...
                for j in range(len(item_teacher)):
                    ...
                    log_string.append(
                        "%.2f/%.2f=%.2f"
                        % (item_coefficient[j], total_coefficient, ratio)
                    )

                    # 尖子生奖金
                    bonus_class = bonus_total * ratio
                    log_string.append(
                        "%.2f*%.2f=%.2f" % (bonus_total, ratio, bonus_class)
                    )
